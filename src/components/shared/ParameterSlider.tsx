    ...
    <div className="flex items-center gap-3 py-1.5 group">
      ...
      <div className="flex-1 flex items-center gap-2">
        <input
          ...
          className={`flex-1 h-2 rounded-full appearance-none ${disabled ? "opacity-50 cursor-not-allowed" : "cursor-pointer"}
        ...
        <input
          ...
          className="w-[72px] text-xs text-right border border-border rounded-md px-2 py-1 bg-card
            focus:outline-none focus:ring-1 focus:ring-ring font-medium disabled:opacity-50"
        />
      </div>
